...
const services = [
  { number: "0", card: "El Loco", title: "La pregunta", eyebrow: "Para cuando necesitas una señal concreta", detail: "Una lectura breve y directa para mirar una situación puntual, ordenar lo que sientes y salir del bucle mental.", includes: "1 pregunta · audio privado · 20 min", price: "$15.000" },
    ...
    <main>
      ...
      <section id="inicio" className="hero shell">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button button-solid" href="#lecturas">Ver lecturas <span>↓</span></a><a className="quiet-link" href="https://www.tiktok.com/@emiliamarsicano" target="_blank" rel="noreferrer">Conoce a Emilia <span>↗</span></a></div>
      ...
      <div className="market-strip"><div className="shell market-strip-inner"><span>Argentina</span><i>·</i><span>Latinoamérica</span><i>·</i><span>Comunidad latina en EE. UU.</span><i>·</i><span>España</span><b>100% online · horarios coordinados por zona</b></div></div>

      <section id="lecturas" className="readings shell section">
        <div className="section-heading"><div><p className="kicker">Elige tu puerta de entrada</p><h2>Una lectura<br /><em>para tu momento.</em></h2></div><p className="section-note">No hay una tirada “correcta”. Hay una pregunta que necesita espacio, una historia que merece ser escuchada y una forma de acompañamiento que puede hacerte bien.</p></div>
      ...
      <section id="emilia" className="about shell section"><div className="about-image"><img src="/emilia.jpg" alt="Retrato en blanco y negro de Emilia Marsicano" /><span className="image-caption">Entre Ríos · Argentina</span></div><div className="about-copy"><p className="kicker">Detrás de las cartas</p><h2>Hola, soy<br /><em>Emilia.</em></h2><p>Leo tarot desde hace alrededor de 15 años y creé Candy Tarot para ofrecer un lugar de escucha, intuición y claridad. Mi forma de leer no busca imponerte un destino: busca ayudarte a entender dónde estás y qué posibilidades se abren ante ti.</p><p>Trabajo online, con tiempo y presencia. Cada lectura parte de tu pregunta real —no de una respuesta en serie— y termina con algo que puedes llevarte a tu vida cotidiana.</p><a className="quiet-link" href="https://www.tiktok.com/@emiliamarsicano" target="_blank" rel="noreferrer">Ver contenido en TikTok <span>↗</span></a></div></section>

      <section id="reservar" className="booking section"><div className="shell booking-inner"><div><p className="kicker">¿Empezamos?</p><h2>Trae tu pregunta.<br /><em>El resto lo vemos en conjunto.</em></h2></div><div className="booking-copy"><p>Cuéntame brevemente qué quieres mirar y te recomendaré la lectura que mejor se ajuste a tu momento. Sin presión, sin respuestas automáticas.</p><a className="button button-light" href="https://www.tiktok.com/@emiliamarsicano" target="_blank" rel="noreferrer">Consultar disponibilidad <span>↗</span></a><small>Las reservas se coordinan por mensaje directo en TikTok. Puedes pagar en ARS, USD o EUR según tu país.</small></div></div></section>

      <section id="preguntas" className="faq shell section"><div><p className="kicker">Antes de reservar</p><h2>Preguntas<br /><em>honestas.</em></h2></div><div className="faq-list"><details open><summary>¿Cómo recibo mi lectura?<span>+</span></summary><p>Las sesiones se coordinan online. Recibes las indicaciones por mensaje directo y, según el servicio, un audio y/o un PDF para volver a escuchar tu lectura.</p></details><details><summary>¿Necesito saber mi hora de nacimiento?<span>+</span></summary><p>Para una carta natal o una sinastría, la hora mejora la precisión del mapa. Si no la sabes, podemos empezar por una lectura de tarot.</p></details><details><summary>¿El tarot predice el futuro?<span>+</span></summary><p>Lo usamos como una herramienta simbólica de reflexión y orientación. No reemplaza atención médica, psicológica, legal o financiera, ni toma decisiones por ti.</p></details><details><summary>¿Puedo hacer una pregunta sobre otra persona?<span>+</span></summary><p>Podemos mirar la dinámica del vínculo y tu lugar en ella, siempre cuidando tu autonomía y evitando presentar como hechos lo que no puede verificarse.</p></details></div></section>

      <footer className="footer"><div className="shell footer-inner"><a className="brand" href="#inicio"><img src="/candy-tarot-logo.png" alt="Candy Tarot" /></a><p>Un lugar para volver a ti.</p><a href="https://www.tiktok.com/@emiliamarsicano" target="_blank" rel="noreferrer">TikTok @emiliamarsicano ↗</a><small>© 2026 Candy Tarot</small></div></footer>
    </main>
  );
}
